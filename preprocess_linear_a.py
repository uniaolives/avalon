...
class LinearAPreprocessor:
    ...
    def __init__(self, json_path, min_occurrence=2, include_ideograms=False):
        ...
        self.vocab = {}
        self.rev_vocab = {}
        self.sequences = []  # lista de listas de IDs de signos (por tabuleta)
        ...
        for seq in self.sequences_ids:
            ...
            for i, center in enumerate(seq):
                ...
                for j in range(start, end):
                    ...
                    # Pode-se ponderar pela distância, mas aqui simplificamos
...
if __name__ == "__main__":
    # Simulação com dados fictícios (caso o arquivo real não exista)
    # Na prática, usaríamos o caminho real do corpus
    import json
